let sizePopulate = function( contents ){
  ...
  for(i=0;i<=contents.length-1;i++){
    let checkData = '<a class="clr dynamic" href="#" target="_self"  >'+ contents[i] +'</a>';
    $('.srozmiar').append(checkData);
    // console.log( tes.kulka.name );
  }
}
...
let models = {
    ...
    'namiot7x5' : {
      ...
      family: ['namiot', 'namiot5x5', 'namiot6x5', 'namiot7x5', 'namiot6n6x5'],
      arya: [
        ['assets/NAMIOTY/5 nog 7,5m zew/d1.json', 'd1', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/d2.json', 'd2', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/d3.json', 'd3', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/d4.json', 'd4', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/d5.json', 'd5', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/n1.json', 'n1', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/n2.json', 'n2', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/n3.json', 'n3', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/n4.json', 'n4', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/n5.json', 'n5', 0xC7C9C7],
        ['assets/NAMIOTY/5 nog 7,5m zew/s1.json', 's1', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/s2.json', 's2', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/s3.json', 's3', 0x54585A],
        ['assets/NAMIOTY/5 nog 7,5m zew/s4.json', 's4', 0x54585A]
      ],
    ...
    'brama' : {
      ...
      family: ['brama', 'prostok6x3', 'prostok8x4', 'prostok10x5'],
      arya: [
    ...
    'rama' : {
      name: 'Rama 5x3',
      family: ['rama', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6'],
      arya: [
    ...
    'rama6x4' : {
      name: 'Rama 6x4',
      family: ['rama5x3', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6'],
      arya: [
    ...
    'slup' : {
      name: 'Slup 2m sr 60',
      family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130'],
      arya: [
