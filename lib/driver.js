var load_consecutive = function(objectFetch, nameFetch, scaleFetch, positionFetch, materialFetch) {
  loader.load(objectFetch, function(object) {
    ...
    // let objot = { [nameFetch] : null }
    chosenArray[nameFetch] = null;
...
var models = [
  [
    _0 = {
      ...
      arya: [
        ...
        // ,        ['assets/LAMANA/4x3wew95/1.json', 'lamana', 0xE87722]
      ],
      scala: 1,
      posiy: -20,
      modposi: function() {
  ...
  [
    _1 = {
      name: 'Balon B12',
      arya: [
        ['assets/BALONY/B12/top.json', 'top', 0xFEDD00],
        ['assets/BALONY/B12/under-top.json', 'under-top', 0x009CDE],
        ['assets/BALONY/B12/over-bottom.json', 'over-bottom', 0x78BE20],
        ['assets/BALONY/B12/bottom.json', 'bottom', 0xE87722]
      ],
      scala: 1,
      posiy: -20,
      modposi: function() {
  ...
  [
    _2 = {
      name: 'Balon B16',
      arya: [
        ['assets/BALONY/B16/top.json', 'top', 0xFEDD00],
        ['assets/BALONY/B16/under-top.json', 'under-top', 0x009CDE],
        ['assets/BALONY/B16/over-bottom.json', 'over-bottom', 0x78BE20],
        ['assets/BALONY/B16/bottom.json', 'bottom', 0xE87722]
      ],
      scala: 1,
      posiy: -20,
      modposi: function() {
