...
// ===================================================================================================================
let dimensionPopulate = function(familyFetch) {
...
let selectActive3 = function(){
  $('.topWrapper3 li[value='+cookieModel+']').addClass('ssActive3');
}
let sortAfterChosen3 = function(){
  ...
  $.each(listitems, function(i, itm) { $('.topWrapper3').append(itm) });
}
