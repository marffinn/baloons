...
let models = {
  ...
  'prostok10x5': {
    ...
    family: ['prostok4x3', 'prostok6x3', 'prostok8x4', 'prostok10x5', 'p_4x3', 'p_6x3', 'p_8x4', 'p_10x5', 'brama_hex'],
    arya: [
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b1.json', 'Banner 1', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b1a.json', 'Banner 2', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b2.json', 'Banner 3', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b2a.json', 'Banner 4', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b3.json', 'Banner 5', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/b3a.json', 'Banner 6', 0x54585A, 't'],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/n1.json', 'Noga 1', 0xC7C9C7],
      ['assets/BRAMY/PROSTOKATNA/10x5 wew sr 180/n2.json', 'Noga 2', 0xC7C9C7],
  ...
  'p_8x4': {
    ...
    arya: [
      ...
      ['assets/BRAMY/POLOKRAGLA/8x4 wew sr 160/br11.json', 'Brama 11', 0xC7C9C7]
    ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
  ...
  'rama6x4': {
    ...
    family: ['rama5x3', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6', 'ramaHex'],
    arya: [
      ['assets/RAMY/r6x4/b1_6x4.json', 'Banner', 0x54585A, 't'],
      ['assets/RAMY/r6x4/r1_6x4.json', 'Rama', 0xC7C9C7]
    ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
  ...
  'rama7x4': {
    ...
    family: ['rama5x3', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6', 'ramaHex'],
    arya: [
      ['assets/RAMY/r7x4/b1_7x4.json', 'Banner', 0x54585A, 't'],
      ['assets/RAMY/r7x4/r1_7x4.json', 'Rama', 0xC7C9C7]
    ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
  ...
  'rama8x6': {
    ...
    family: ['rama5x3', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6', 'ramaHex'],
    arya: [
      ['assets/RAMY/r8x6/b1_8x6.json', 'Banner', 0x54585A, 't'],
      ['assets/RAMY/r8x6/r1_8x6.json', 'Rama', 0xC7C9C7]
    ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
  ...
  'rama10x6': {
    ...
    family: ['rama5x3', 'rama6x4', 'rama7x4', 'rama8x6', 'rama10x6', 'ramaHex'],
    arya: [
      ['assets/RAMY/r10x6/b1_10x6.json', 'Banner', 0x54585A, 't'],
      ['assets/RAMY/r10x6/r1_10x6.json', 'Rama', 0xC7C9C7]
    ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
