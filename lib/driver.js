...
let initializeSelect = function() {
  $('.sizeSelector2 select').hide();
  let csWrap = '<div class="clickOverlay"><ul class="topWrapper"></ul></div>';
  $('.sizeSelector2').append(csWrap);
  $('.sizeSelector2 option').each(function() {
    let csOption = '<li>' + $(this).text() + '</li>';
...
let sizePopulate = function(familyFetch) {
  $('.sizeSelector2 select').empty();
  for (i = 0; i <= familyFetch.length - 1; i++) {
    let opt = '<option value="' + familyFetch[i] + '">' + familyFetch[i] + '</option>';
    $('.sizeSelector2 select').append(opt);
  }
  initializeSelect();
}
...
$(document).on('click', 'li', function() {
  $('.sizeSelector2 select').empty();
  chosenModel = $(this).text();
  cookieModel = $(this).text();
  history.pushState(null, null, 'index_2.php?model=' + chosenModel);
  Cookies.set(chosenModel, chosenArray, {
    expires: 7
  });
  $('.sizeSelector2 ul li').each(function() {
    $(this).removeClass('selected')
  });
  $(this).toggleClass('selected');
  $(this).prependTo($(this).parent());
  var mylist = $('.topWrapper');
  var listitems = $('li:not(.selected)', mylist).get();
...
let load_consecutive = function(objectFetch, nameFetch, positionFetch, materialFetch, familyFetch, mainName) {
  loader.load(objectFetch, function(object) {
    ...
    objectile.scale.set(scaleModel, scaleModel, scaleModel);
    objectile.name = nameFetch;
    colorHEX = '#' + materialFetch.color.getHexString().toUpperCase();
...
let models = {
  ...
  'polokr4x3': {
    ...
    arya: [
      ['assets/POLOKRAGLA/4x3 wew sr 95/b1.json', 'Banner 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/b1a.json', 'Banner 2', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/b2.json', 'Banner 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/b2a.json', 'Banner 4', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/b3.json', 'Banner 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/b3a.json', 'Banner 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br1.json', 'Rama 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br2.json', 'Rama 2', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br3.json', 'Rama 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br4.json', 'Rama 4', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br5.json', 'Rama 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br6.json', 'Rama 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br7.json', 'Rama 7', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br8.json', 'Rama 8', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br9.json', 'Rama 9', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br10.json', 'Rama 10', 0x54585A],
      ['assets/POLOKRAGLA/4x3 wew sr 95/br11.json', 'Rama 11', 0x54585A]
    ],
  ...
  'polokr6x3': {
    ...
    family: ['kula', 'b12', 'b16'],
    arya: [
      ['assets/POLOKRAGLA/6x3 wew sr 130/b1.json', 'Banner 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/b1a.json', 'Banner 2', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/b2.json', 'Banner 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/b2a.json', 'Banner 4', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/b3.json', 'Banner 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/b3a.json', 'Banner 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br1.json', 'Rama 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br2.json', 'Rama 2', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br3.json', 'Rama 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br4.json', 'Rama 4', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br5.json', 'Rama 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br6.json', 'Rama 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br7.json', 'Rama 7', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br8.json', 'Rama 8', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br9.json', 'Rama 9', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br10.json', 'Rama 10', 0x54585A],
      ['assets/POLOKRAGLA/6x3 wew sr 130/br11.json', 'Rama 11', 0x54585A]
    ],
  ...
  'polokr8x4': {
    ...
    family: ['kula', 'b12', 'b16'],
    arya: [
      ['assets/POLOKRAGLA/8x4 wew sr 160/b1.json', 'Banner 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/b1a.json', 'Banner 2', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/b2.json', 'Banner 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/b2a.json', 'Banner 4', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/b3.json', 'Banner 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/b3a.json', 'Banner 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br1.json', 'Rama 1', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br2.json', 'Rama 2', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br3.json', 'Rama 3', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br4.json', 'Rama 4', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br5.json', 'Rama 5', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br6.json', 'Rama 6', 0xC7C9C7],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br7.json', 'Rama 7', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br8.json', 'Rama 8', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br9.json', 'Rama 9', 0x54585A],
      ['assets/POLOKRAGLA/8x4 wew sr 160/br10.json', 'Rama 10', 0x54585A]
    ],
