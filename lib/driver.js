...
load_consecutive = function (objectFetch, nameFetch, materialFetch) {
...
$('.bnd').on('click', function () {
  let noAddins = null;
  animIn(cookieModel,noAddins);
});

function animIn(model_name, noAddins) {

  // ustalenie ktory model ma byc wczytany /////////////////////////////
  model = models[model_name];
  cookieModel = model_name;
  //////////////////////////////////////////////////////////////////////

  // czyszczenie tablic przechowywujacych //////////////////////////////
  raycastArray = [];
  chosenArray = {};
  //////////////////////////////////////////////////////////////////////

  // usuwanie wszystkich czesci modelu z grupy /////////////////////////
  for (var i = group_main.children.length - 1; i >= 0; i--) {
    group_main.remove(group_main.children[i]);
  }
  //////////////////////////////////////////////////////////////////////

  // wgrywanie typu modelu /////////////////////////////////////////////
  sizePopulate(model.family);
  // wczytywanie rozmiarow modelu //////////////////////////////////////
  dimensionPopulate(model.dimensions);

  if( typeof model.dimensions !== 'undefined' ){
    let dta = model.dimensions[0][1];
    group_main.scale.set( dta,dta,dta );
  }
  //  !! jezeli model posiada rozmiar wczytaj pierwszy z tabeli ////////

  // funkcja wczytujaca czesci modelu   ////////////////////////////////
  for (i = 0; i <= model.arya.length - 1; i++) {
    ...
    load_consecutive(model.arya[i][0], model.arya[i][1], mates);
  }
  //////////////////////////////////////////////////////////////////////

  // if model has additional options - load them in ////////////////////
  if(typeof model.additional_opt === 'function') {
    if( noAddins !== null ){
      if( $('.cwn').length ){
        // console.log('jest juz ta opcja');
      } else {
        model.additional_opt();
      }
    }
  }
  else { 
...
let models = {
  ...
  'balon': {
    ...
    additional_opt: function(){
      let option = '<a class="clr cwn" href="#" target="_self" data-lang="ALL_PRINT"> Cały w nadruku</a>';
      $('.skolory .listerFoldable').append(option);
    }
  },
  'b12': {
    name: 'Balon B12',
  ...
  'slup': {
    ...
    arya: [      ['assets/SLUPY/2m sr 60cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup2x5sr60': {
    name: 'Slup 2,5m sr 60',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/2,5m sr 60/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup3sr60': {
    name: 'Slup 3m sr 60',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/3m sr 60cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup4sr80': {
    name: 'Slup 4m sr 80',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/4m sr 80cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup4sr100': {
    name: 'Slup 4m sr 100',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/4m sr 100cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup5sr100': {
    name: 'Slup 5m sr 100',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/5m sr 100cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slup5sr130': {
    name: 'Slup 5m sr 130',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
    arya: [      ['assets/SLUPY/5m sr 130cm/w.json', 'Słup', 0x54585A, 't']    ],
  },
  'slupKrzywy': {
    name: 'Slup 5m sr 130',
    family: ['slup', 'slup2x5sr60', 'slup3sr60', 'slup4sr80', 'slup4sr100', 'slup5sr100', 'slup5sr130', 'slupKrzywy'],
