// let complexLoader = function( aryaIn, posiY, scaleY ){
//
//   for( i=0 ; i<= aryaIn.length - 1; i++ ){
//
//     let namesvar = aryaIn[i][1];
//     let scalevar = posiY;
//     let posiYvar = scaleY;
//
//     loader.load( aryaIn[i][0] , function (object) {
...
var models = [
    [
        _0 = {
            ...
            loadmodel:
            // complexLoader( this.arya, this.posiy, this.scala  )
