let sizePopulate = function(familyFetch) {
  for (i = 0; i <= familyFetch.length - 1; i++) {
    ...
    let opt = '<option value="' + familyFetch[i] + '">' + niceName + '</option>';
...
let initializeSelect = function() {
  ...
  $('.sizeSelector2').append( '<div class="clickOverlay"><ul class="topWrapper"></ul></div>' );
  $('.sizeSelector2 option').each(function() {

    let csOption = '<li value="'+ $(this).attr('value') +'">' + $(this).text() + '</li>';
