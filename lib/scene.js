...
function onDocumentMouseMove(event) {
  ...
  if (intersects.length > 0) {
    ...
    // objectHovered = scene.getObjectByName(intersects[0].object.name, true);
    // let tempColor = objectHovered.material.color;
    // objectHovered.material.color.set('red');
    // console.log(objectHovered);

  } else {

    $('html,body').css('cursor', 'default');
    // objectHovered.material.color.set(0xC7C9C7);
