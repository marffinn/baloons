...
let linkInterpreter = function(cookieModel) {


  // history.pushState("bar", "page 2", "bar.html");
...
$('.sendMail').on('click', function() {
  ...
  Email.send({
    ...
    Body: "<b>Osoba kontaktowa: </b>" + xOsoba + "<br/>" +
      ...
      "<b>Oznaczenie produktu: </b>" + chosenModel + "<br/>" +
      "<b>Link strony: </b>" + xLink + "<br/>" +
