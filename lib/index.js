...
$('input, textarea').on('click', function() {
  $(this).focus();
}); // somehow chrome browser has issues with triggering :focus state automatically
...
$('.sendMail').on('click', function(){
  ...
  let xMailBody   = $('.mailBody').val();
  let xEmail      = $('.x_email').val();
  // console.log(xEmail);

  Email.send({
      SecureToken : "02277365-2d3a-49c0-832a-1540deaf5d28",
      To : ['marffinn@gmail.com','bartosz@yprojects.pl','produkcja.felder@gmail.com'],
      From : xEmail,
      Subject : "Zamówienie - KONFIGURATOR",
      Body : xMailBody
  }).then(
