...
let models = {
  ...
  'balon': {
    ...
    dimensions: [ ['2m', 1] , ['3m', 1.2], ['4m', 1.6], ['6m', 1.8]],
    loadmodel: function () {
  ...
  'b12': {
    ...
    dimensions: [['2m', 1] , ['3m', 1.8], ['4m', 2], ['6m', 2.2], ['8m', 2.2], ['10m', 2.2]],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
      dimensionPopulate(this.dimensions);
  ...
  'prostok4x3': {
    ...
    dimensions: [['4x3 m', 1] , ['6x3 m', 1.2], ['8x4 m', 1.4] ,['10x5 m', 1.6] ],
    loadmodel: function () {
      let family = this.family;
      sizePopulate(family);
      dimensionPopulate(this.dimensions);
